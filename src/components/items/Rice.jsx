...
//     toast.success(`$(img), ${productName} added to Cart!`,{position:"top-right",autoClose:3000,hideProgressBar:false,closeOnClick:true,pauseOnHover:true,draggable:true,progress:undefined,});
//   };
...
//                     img: product.img,
//                   })
//                   showToast(product.img,product.productName)
//                 }}
//                 className="bg-white flex items-center border-green-500 text-black px-4 py-1 rounded-full hover:bg-green-600"
//               >
//                 Add to <IoCartOutline />
            ...
            <div className="mt-1 flex justify-between gap-5 w-full bg-gray-200 p-4 rounded-t-md rounded-b-2xl">
              <button
                onClick={() => {
                  ...
                  showToast(product.productName); // Show toast
                }}
                className="bg-white flex items-center border-green-500 text-black px-4 py-1 rounded-full hover:bg-green-600"
              >
                Add to <IoCartOutline />
