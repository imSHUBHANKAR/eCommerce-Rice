...
function Rice() {
  ...
  //for toast message
  const showToast=(img,productName)=>{
    toast(
      <div className="flex items-center gap-4">
        <img src={img} alt={productName} className="w-10 h-10 object-cover rounded-full" />
        <p className="text-black">{productName} <span>Added</span></p>
      </div>,
      {position:"top-right",
        autoClose:3000,
