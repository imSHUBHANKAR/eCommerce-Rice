    ...
    <div>
      ...
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-light text-center sm:text-xl">
          Got a technical issue? Want to send feedback about a Agsure feature? Need details about our Business plan? Let us know.
        </p>
      ...
      {showAlert && (
          <div className="fixed top-5 right-5 bg-green-500 text-white px-4 py-2 rounded-md shadow-lg">
            <p>Thankyou!</p>
            <p>Our Team will contact you soon within 4 hr. Thank</p>
          </div>
        )}
    </section>
    </div>
